                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9 col-xl-9">
                        ...
                        <div class="tm-blog-post">
                            ...
                            <div class="img-fluid tm-img-post"><a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'large' ); ?></a></div>
                        ...
                        ?>
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 py-4">
